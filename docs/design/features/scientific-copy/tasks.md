...
- [x] Inspect governing ADRs, shared-shell API, RotorVitals and all numerical engines (R-C01–04).
- [x] Verify primary algorithm documentation and persist implementation dossier (R-C02).
