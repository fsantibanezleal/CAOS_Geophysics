# Historical source audit: release 0.03.000

This retained audit describes the superseded algorithms. It is not the current
implementation contract. See [the recovery dossier](../scientific-implementation.md).
