...
| [SimPEG joint inversion tutorial](https://docs.simpeg.xyz/latest/content/user-guide/tutorials/13_joint_inversion/plot_inv_3_cross_gradient_pf.html) | Structural coupling between potential-field models | Dimensionless cross-gradient penalty; shared and conflicting structures |
